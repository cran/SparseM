...
c
c Modified by Pin Ng on 6/27/02 to be called by R
c
c-----------------------------------------------------------------------
c on entry:
c---------
...
c outfil = character*72 that contains the name of the output file
c
c on return:
c---------- 
...
c-----------------------------------------------------------------------
     ...
     *	        guesol*2, rhstyp*3, outfil*72
      integer totcrd, ptrcrd, indcrd, valcrd, rhscrd, nrow, ncol,
     1     nnz, nrhs, len, nperli, nrwindx, iounit, neltvl
      integer ja(*), ia(*) 	
      real*8 a(*),rhs(*)
c--------------
...
c     write 4-line or five line header
     ...
     1     rhscrd,type,nrow,ncol,nnz,neltvl,ptrfmt,indfmt,valfmt,valfmt
c-----------------------------------------------------------------------
      nrwindx = 0
