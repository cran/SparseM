...
c-----------------------------------------------------------------------
      ...
      integer ja(*),jb(*), ia(*),ib(*), n,rel, len,ierr
c-----------------------------------------------------------------------
...
c
      index = 1
c     was computed goto:  --    goto (100,200,300,400) rel
      if(rel .eq. 1) then ! --------------- rel = 1 --------------
       do row= 1,n
         k1 = ia(row)
         k2 = ia(row+1) - 1
         ib(row) = index
