...
\begin{Soutput}
         [,1]      [,2]      [,3]     [,4]
[1,] 0.000000  0.000000  0.000000 1.546872
[2,] 1.157396 -1.113925  1.566875 0.000000
[3,] 0.000000  0.000000  0.000000 1.063925
[4,] 0.000000  0.000000 -2.694072 0.000000
[5,] 1.551085  0.000000  0.000000 0.000000
\end{Soutput}
\begin{Sinput}
...
Slot "ra":
[1]  1.546872  1.157396 -1.113925  1.566875  1.063925 -2.694072  1.551085
...
\end{Sinput}
\begin{Soutput}
slm time = 2.23 0.82 3.04 0 0 
\end{Soutput}
\begin{Sinput}
> cat("lm time =", lm.time, "\n")
\end{Sinput}
\begin{Soutput}
lm time = 3.88 1.16 5.06 0 0 
\end{Soutput}
\begin{Sinput}
> cat("slm.fit time =", slm.fit.time, "\n")
\end{Sinput}
\begin{Soutput}
slm.fit time = 0.09 0.04 0.13 0 0 
\end{Soutput}
\begin{Sinput}
> cat("lm.fit time =", lm.fit.time, "\n")
\end{Sinput}
\begin{Soutput}
lm.fit time = 2.66 0.26 2.91 0 0 
\end{Soutput}
\begin{Sinput}
...
we would especially like to see in the near future: \texttt{crossprod},
\texttt{row},\texttt{ col}, \texttt{eigen}, \texttt{det}, \texttt{svd} and the
set of functions for QR decomposition. 
...
this suggestion, but we hope that someone else might be inspired to do so.
